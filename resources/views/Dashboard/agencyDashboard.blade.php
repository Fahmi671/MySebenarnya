...
<head>
    ...
    <style>
        ...
        .total-inquiry-box {
            ...
            border-radius: 12px;
            box-shadow: 0 2px 6px rgba(125,6,6,0.07);
...
<body>
   <header class="header">
    ...
    <nav class="sidebar" aria-label="Agency sidebar">
        ...
        <ul class="menuitems">
            <li><a href="{{ route('Dashboard.agencyDashboard') }}" class="menuitem active">Home</a></li>
    ...
    <div class="main-content">
        ...
        <div class="content-box">
            <div class="total-inquiry-box">
                <div class="inquiry-info">
                    <div class="inquiry-label">Total Inquiry Assigned (Accepted)</div>
                    <div class="inquiry-total">{{ $acceptedCount ?? '-' }}</div>
                </div>
            </div>
        </div>
    </div>
