...
<body>
    ...
    <button onclick="location.href='{{ route('GenerateReport.mcmcGenerateInquiryReport') }}'" class="report-btn">
        <i class="fas fa-file-alt"></i> Generate Inquiry Report
    </button>
    <button onclick="location.href='{{ route('GenerateReport.mcmcInquiryAssignmentReport') }}'" class="report-btn">
        <i class="fas fa-tasks"></i> Generate Inquiry Assignment Report
    </button>
    <button onclick="location.href='{{ route('GenerateReport.mcmcAgencyPerformanceReport') }}'" class="report-btn">
        <i class="fas fa-chart-line"></i> Generate Agency Performance Report
    </button>
</div>
